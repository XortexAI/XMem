...
var codeSystemPrompt = `You are a senior software engineer knowledge extractor.
...
func PackCodeQuery(query string) string {
	return "Extract code annotations from this developer conversation:\n\n" + query
}
