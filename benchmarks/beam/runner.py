"""BEAM benchmark orchestration against the Python XMem API."""
...
from .dataset import BeamExample, build_ingest_items, load_examples, select_examples
...
class BeamRunner:
    ...
    async def run(self) -> dict[str, Any]:
        examples = select_examples(
            load_examples(self.config.dataset_path, split=self.config.split),
        ...
        summary = summarize_results(results, group_field="question_type")
