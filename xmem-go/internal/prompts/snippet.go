...
var snippetSystemPrompt = `You are a developer's personal code assistant and knowledge extractor.
...
func BuildSnippetSystemPrompt() string {
	return snippetSystemPrompt
}

func PackSnippetQuery(query string) string {
	return "Extract code snippets from this developer message:\n\n" + query
}
